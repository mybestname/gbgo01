...
const (
	...
	transportPackage = protogen.GoImportPath("my/transport/http")
	bindingPackage   = protogen.GoImportPath("my/transport/http/binding")
)

var methodSets = make(map[string]int)

// generateHttpFile generates a _http.pb.go file containing my.api http definitions.
func generateHttpFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	if len(file.Services) == 0 {
		return nil
	}
	filename := file.GeneratedFilenamePrefix + "_http.pb.go"
	g := gen.NewGeneratedFile(filename, file.GoImportPath)
	g.P("// Code generated by protoc-gen-my-ext --my-ext_out=http=true. DO NOT EDIT.")
	...
	g.P()
	generateHttpFileContent(gen, file, g)
	return g
}

// generateHttpFileContent generates the my.api http definitions, excluding the package statement.
func generateHttpFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	if len(file.Services) == 0 {
		return
	}
